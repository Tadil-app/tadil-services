export const ur = {
  ...
  profileSettings: {
    ...
    profile: {
      ...
      locationSet: "مقام طے ہو گیا",
      mapHint: "پن کو اپنی گلی پر دبائیں یا کھینچیں",
      selectedLocation: "منتخب مقام",
      locating: "مقام تلاش کیا جا رہا ہے…",
      pickOnMapFirst: "نقشے پر ایک مقام منتخب کریں",
      latitude: "عرض البلد",
      longitude: "طول البلد",
  ...
  courier: {
    ...
    orderDetails: {
      ...
      deliverToTailor: "درزی کو ڈلیور کریں",
      deliverToCustomer: "گاہک کو ڈلیور کریں",
      markAsDelivered: "ڈلیور شدہ کے طور پر نشان زد کریں",
      deliveryAddress: "ترسیل کا پتہ",
    },
    print: {
      title: "شپنگ لیبل اور رسید",
      orderRef: "آرڈر #",
      date: "تاریخ:",
      from: "سے (صارف)",
      name: "نام:",
